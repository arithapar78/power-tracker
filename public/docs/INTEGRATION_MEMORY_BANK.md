...
- Added Firebase/Firestore host permissions for cloud sync capabilities
- Scoped host permissions to specific Firebase endpoints for better security
...
```json
{
  ...
  "host_permissions": [
    "https://firestore.googleapis.com/*"  // Firebase/Firestore cloud sync (v6.0.0+)
  ]
}
```
